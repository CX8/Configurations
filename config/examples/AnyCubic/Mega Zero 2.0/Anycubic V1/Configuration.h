...
// #define STRING_CONFIG_H_AUTHOR "(Chris, Anycubic Mega)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Caffettino Bot"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Mega Zero, generated with M303 C8 S190
    ...
    #define DEFAULT_Kd_LIST {  72.67,  72.67 }
  #else
    #define DEFAULT_Kp 21.90
    #define DEFAULT_Ki 1.65
    #define DEFAULT_Kd 72.67
  #endif
#endif // PIDTEMP
...
//   #define DEFAULT_bedKd 523.14
  #define DEFAULT_bedKp 38.87
  #define DEFAULT_bedKi 7.41
  #define DEFAULT_bedKd 135.88
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -8.2, -2.45 }
